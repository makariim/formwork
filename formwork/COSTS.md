...
run of all twelve checks over 183 files, including the fixtures each check is tried
...
183 files. Plain text and a few small programs. Python 3, standard library only,
